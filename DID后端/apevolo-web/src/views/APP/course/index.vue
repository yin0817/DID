<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="grade" label="课程等级">
        <template slot-scope='scope'>
          <el-tag v-if='scope.row.grade === 0'>初级</el-tag>
          <el-tag v-else-if='scope.row.grade === 1'>中级</el-tag>
          <el-tag v-else>高级</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="price" label="课程价格" />
      <el-table-column prop="buyNum" label="购买人数" />
...
import { list, del } from '@/api/APP/course'
