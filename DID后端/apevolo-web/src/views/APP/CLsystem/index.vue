<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="grade" label="系统类型">
        <template slot-scope='scope'>
          {{scope.row.type === 0 ? 1 : 12}}个月
        </template>
      </el-table-column>
      <el-table-column prop="price" label="系统价格" />
...
import { list, del } from '@/api/APP/CLsystem'
