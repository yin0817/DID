<template>
  <div class="app-container">
    ...
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="memo" label="销毁原因" />
      <el-table-column prop="hashCode" label="销毁hash地址" />
      <el-table-column prop="eotc" label="销毁eotc数量" />
      <el-table-column prop="destructionDate" label="销毁日期">
        <template slot-scope='scope'>
          {{ transformDate(scope.row.destructionDate) }}
        </template>
      </el-table-column>
...
import { list, del } from '@/api/DAO/destroy'
