<template>
	<div class="Nav-container" id="nav">
		<van-nav-bar fixed placeholder z-index="10" @click-left="onClickLeft" @click-right="onClickRight" :border="false">
			<template #left>
		...
		<van-popup v-model="zhiyaShow" position="left" get-container="#nav" class="pop">
			<div class="content">
