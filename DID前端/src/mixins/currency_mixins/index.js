...
export default {
  ...
  methods: {
    ...
    onMinLegalTender(e) {
      ...
      if (0 < parseFloat(value) && value <= (parseFloat(this.price) * parseFloat(this.number)).toFixed(2)) {
    ...
    onMaxLegalTender(e) {
      ...
      if (value >= parseFloat(this.MinLegalTender) && value <= (parseFloat(this.price) * parseFloat(this.number)).toFixed(2)) {
